...
import com.samsung.android.sdk.penremote.SpenRemote.Error
import com.samsung.android.sdk.penremote.SpenUnit
import com.samsung.android.sdk.penremote.SpenUnitManager
import pl.jojczak.penmouses.di.ActivityProvider
import pl.jojczak.penmouses.service.listeners.AirMotionEventListener
import pl.jojczak.penmouses.service.listeners.ButtonEventListener
...
class SPenManager(
    ...
    fun connect(sPenManagerConnectionResultCallback: ConnectionResultCallback) {
        ...
        val activity = activityProvider.getActivity() ?: run {
            ...
            sPenManagerConnectionResultCallback.onFailure(Error.UNKNOWN)
            return
        }
        ...
        if (isSPenSupported()) {
            ...
            sPenManagerConnectionResultCallback.onFailure(Error.UNSUPPORTED_DEVICE)
        }
    }
